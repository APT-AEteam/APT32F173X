...
******************************************************************************/
static inline void csp_fvr_enable(csp_fvr_t *ptFvrBase)
{
	ptFvrBase->CR |= FVR_EN_MSK;
}

static inline void csp_fvr_disable(csp_fvr_t *ptFvrBase)
{
	ptFvrBase->CR &= ~FVR_EN_MSK;
}
...
static inline void csp_fvr_set_cmpref(csp_fvr_t *ptFvrBase,  fvr_cmpref_e eOpacmpref)
{
	ptFvrBase->CR = (ptFvrBase->CR & (~FVR_CMPREF_MSK)) | (eOpacmpref << FVR_CMPREF_POS);
}

static inline void csp_fvr_set_opacm(csp_fvr_t *ptFvrBase, fvr_opacm_e eOpacm)
{
	ptFvrBase->CR = (ptFvrBase->CR & (~FVR_OPACM_MSK)) | (eOpacm << FVR_OPACM_POS);
}

static inline void csp_fvr_buf_enable(csp_fvr_t *ptFvrBase)
{
	ptFvrBase->CR |= FVR_BUFEN_MSK;
}

static inline void csp_fvr_buf_disable(csp_fvr_t *ptFvrBase)
{
	ptFvrBase->CR &= ~FVR_BUFEN_MSK;
}
...
static inline void csp_fvr_bufin_disable(csp_fvr_t *ptFvrBase)
{
	ptFvrBase->CR  &= ~FVR_BUFIN_MSK;
}
