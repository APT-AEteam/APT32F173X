...
#define IWDT_IDX  			1		//IWDTx id number
...
#define PFLASH_PAGESIZE		256
#define PFLASH_PAGENUM		512
#define PFLASH_LIMIT		(PFLASH_BASE + PFLASH_SIZE) 
#define DFLASH_BASE			0x10000000
#define DFLASH_SIZE			0x00002000					//8KB
#define DFLASH_PAGESIZE		64
#define DFLASH_PAGENUM		128
...
#define APB_IIC0_BASE   	(APB_PERI_BASE + 0xA0000)
