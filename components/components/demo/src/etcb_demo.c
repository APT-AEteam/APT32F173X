...
int etcb_one_trg_one_demo(void)
{
	...
	tEtbConfig.eSrcIp  = ETB_EXI_TRGOUT0 ;  	    //EXI1 触发输出0作为触发源
	tEtbConfig.eSrcIp1 = ETB_SRC_NOT_USE;          //无触发源2      
	tEtbConfig.eSrcIp2 = ETB_SRC_NOT_USE;          //无触发源3
	tEtbConfig.eDstIp =  ETB_BT0_SYNCIN0;   	    //BT0 同步输入作为目标事件
	tEtbConfig.eDstIp1 = ETB_DST_NOT_USE;          //无目标事件2
	tEtbConfig.eDstIp2 = ETB_DST_NOT_USE;          //无目标事件3
...
int etcb_one_trg_more_demo(void)
{
	...
	tEtbConfig.eSrcIp2 = ETB_SRC_NOT_USE;          //无触发源3
	tEtbConfig.eDstIp =  ETB_BT0_SYNCIN0;   	    //BT0 同步输入作为目标事件
	tEtbConfig.eDstIp1 = ETB_BT1_SYNCIN0;          //无目标事件2
	tEtbConfig.eDstIp2 = ETB_BT2_SYNCIN0;          //无目标事件3
	tEtbConfig.eTrgMode = ETB_HARDWARE_TRG;
