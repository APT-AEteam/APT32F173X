...
{	
  uart_char_demo_test();
  uart_receive_demo_test();
  uart_recv_dma_demo_test();
  uart_recv_dynamic_demo_test();
  uart_recv_dynamic_int_demo_test();
  uart_recv_int_demo_test();
  uart_send_demo_test();
  uart_send_dma_demo_test();
  uart_send_int_demo_test_test();
}

int uart_send_dma_demo_test(void)
{
	int iRet = 0;
 ...
 *  \return error code
 */
int uart_recv_dma_demo_test(void)
{
	int iRet = 0;
	csi_uart_config_t tUartConfig;				//UART1 参数配置结构体
 ...
 *  \return error code
 */
int uart_send_int_demo_test_test(void)
{
	int iRet = 0;
 ...
 *  \return error code
 */
int uart_receive_demo_test(void)
{
	int iRet = 0;
 ...
 *  \return error code
 */
int uart_recv_int_demo_test(void)
{
	int iRet = 0;
	uint8_t  byRxBuf[32];
 ...
 *  \return error code
 */
int uart_recv_dynamic_demo_test(void)
{
	int iRet = 0;
	uint8_t byRxBuf[128];
 ...
 *  \return error code
 */
int uart_recv_dynamic_int_demo_test(void)
{
	int iRet = 0;
	uint8_t byRxBuf[128];
