...
csi_clk_config_t tClkConfig = 
	//{SRC_HFOSC, HFOSC_24M_VALUE, SCLK_DIV1, PCLK_DIV1, 5556000, 5556000};
	//{SRC_HFOSC, HFOSC_12M_VALUE, SCLK_DIV1, PCLK_DIV1,5556000, 5556000};
	//{SRC_HFOSC, HFOSC_6M_VALUE, SCLK_DIV1, PCLK_DIV1,5556000, 5556000};
	//{SRC_HFOSC, HFOSC_3M_VALUE, SCLK_DIV1, PCLK_DIV1,5556000, 5556000};
	{SRC_AUTO_HF_PLL, PLL_VALUE, SCLK_DIV2, PCLK_DIV1, 5556000, 5556000};
	//{SRC_AUTO_EM_PLL, PLL_VALUE, SCLK_DIV2, PCLK_DIV1, 5556000, 5556000};
	//{SRC_MANUAL_PLL, PLL_105M_VALUE, SCLK_DIV2, PCLK_DIV1, 5556000, 5556000};
